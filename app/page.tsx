...
const CTA_LABEL = "View the sequence";
      ...
      <main className="flex-1">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
            <div>
              <h1 className="text-4xl font-semibold tracking-tight text-balance sm:text-5xl">
                Your sequence doesn&apos;t ship until it agrees with itself.
              </h1>
              <p className="mt-5 max-w-[46ch] text-base text-muted-foreground">
                Dailies generates a shot, watches its own footage, writes real
                VFX notes, and revises until the sequence holds together.
              </p>
              <div className="mt-8">
                <Button
                  render={
            ...
            <div>
              ...
              <p className="mt-2 font-mono text-xs text-muted-foreground">
                SH020, generated by Dailies. Not stock footage.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-border">
          <div className="mx-auto max-w-7xl px-6 py-20 text-center">
            <h2 className="mx-auto max-w-[20ch] text-2xl font-semibold tracking-tight text-balance sm:text-3xl">
              See the sequence Dailies is still working on.
            </h2>
